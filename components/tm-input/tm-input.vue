      ...
      >
        ...
        >
          ...
          <input
            ...
            :placeholder="
              String(props.modelValue).length > 0 ? '' : propsDetail.placeholder
            "
            :style="[
              {
                height: `${_height}rpx`,
            ...
            :placeholder-style="`fontSize:${propsDetail.fontSize_px}px;color:${
              String(props.modelValue).length > 0 ? '#00000000' : tmcomputed.textColor
            };opacity:0.5`"
          />
